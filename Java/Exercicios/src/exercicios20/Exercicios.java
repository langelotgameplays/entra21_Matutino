...
public class Exercicios {
	...
	public static void main(String[] args) {
			...
			int cidade = JOptionPane.showOptionDialog(null,"Escolha um estado",
				"Estados",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE,null,cidades1,cidades1[0]);
			...
			int cidade = JOptionPane.showOptionDialog(null,"Escolha um estado",
				"Estados",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE,null,cidades2,cidades2[0]);
			...
			int cidade = JOptionPane.showOptionDialog(null,"Escolha um estado",
				"Estados",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE,null,cidades3,cidades3[0]);
